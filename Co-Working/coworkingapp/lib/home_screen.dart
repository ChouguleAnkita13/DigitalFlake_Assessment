              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: const [BoxShadow(color: Color.fromRGBO(0, 0, 0, 0.2),offset: Offset(1,1),blurRadius: 10 )]
                  ),
                  child: GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context)=>BookingHistory(selectedType:selectedType)));
                ...
                Column(
                  children: [
                    Container(
                      ...
                      Navigator.of(context).push(MaterialPageRoute(builder: (context)=>DeskScreen(selectedType:selectedType)));
